...
internal class GeoTrackingConfiguration extends Configuration {
    ...
    public function GeoTrackingConfiguration() {
        super();
    }
    /**
    ...
    /**
     * Determines if geo tracking supports a particular location.
     *
     * This function returns false under the following circumstances:
     *
     * <ul>
     *     <li>ARKit lacks localization imagery for the user’s geographic position.</li>
     *     <li>A network connection is unavailable to download localization imagery.</li>
     *     <li>The device lacks cellular (GPS) capability</li>
     * </ul>
     *
     * @param completionHandler Code you supply that runs after this function returns.
     * The closure takes a boolean argument that indicates whether geo tracking is available.
     * @param coordinate (Optional) The GPS location that the framework checks for availability.
     */
    public static function checkAvailability(completionHandler:Function, coordinate:Coordinate = null):void {
        var ret:* = ARANEContext.context.call("checkGeoTrackingAvailability", coordinate,
    ...
    public static function get isSupported():Boolean {
        var ret:* = ARANEContext.context.call("isSupported_GeoConfig");
        if (ret is ANEError) throw ret as ANEError;
