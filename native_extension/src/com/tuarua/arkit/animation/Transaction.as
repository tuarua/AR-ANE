...
public class Transaction {
    ...
    public static function begin():void {
        var ret:* = ARANEContext.context.call("transaction_begin");
        if (ret is ANEError) throw ret as ANEError;
    }

    /** Commit all changes made during the current transaction. */
    public static function commit():void {
        var ret:* = ARANEContext.context.call("transaction_commit");
        if (ret is ANEError) throw ret as ANEError;
    }
    ...
    private static function setANEvalue(name:String, value:*):void {
        var ret:* = ARANEContext.context.call("transaction_setProp", name, value);
        if (ret is ANEError) throw ret as ANEError;
    }
